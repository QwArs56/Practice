...
Tetris/
1) Main.cpp (WinMain) - основной файл
2) IO.cpp, IO.h - файлы для работы с графикой
3) Pieces.cpp, Pieces.h - файлы для создания тетромино
4) Board.cpp, Board.h - файлы для настройки игрового поля
5) Game.cpp, Game.h - файлы для создание логики игры и её игрового цикла
